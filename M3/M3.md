...
**M3 additions to API** (4 new endpoints):
```
GET  /qubicbridge/v1/evm/pending-proposals           - Fetch pending from contract
GET  /qubicbridge/v1/evm/get-proposals?filter={STATUS} - Filter by PENDING/APPROVED/EXECUTED
POST /qubicbridge/v1/evm/set-fee-recipient-evm      - Change fee recipient
POST /qubicbridge/v1/evm/proposals-direct            - Database-only sync update
```

See [API_ENDPOINTS.md](API_ENDPOINTS.md) for complete API documentation (34 endpoints total).
